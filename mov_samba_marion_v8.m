...
% --------------------------------------------------------
% Align the T/S dates (concat_IESsamba, now 2013-09-2022-12) with
% Total_TPUD's dates (Marion's file, still 2013-2017) by explicit
% intersection rather than assuming the two arrays are already the
% same length/order. See v8 note above.
...
if frac_diff>0
    warning('mov_samba_marion_v8:dx1TimeVarying', ...
