...
% Informational only (not a bias risk since v10 -- dx2 now tracks dx1's
% real per-day mask exactly): how much the coverage mask actually
% varies across days, for context.
mask=isnan(dx1);
